...
if (parseInt(a) > 0 && parseInt(a) < 10 && parseInt(b) > 0 && parseInt(b) < 10) {
    ...
    parseInt(a) > 9 && parseInt(a) <= 31 && parseInt(b) > 9 && parseInt(b) <= 12
) {
    console.log(a + '/' + b + '/' + c)
} else if (
    parseInt(a) > 0 && parseInt(a) < 10 && parseInt(b) > 9 && parseInt(b) <= 12
) {
    console.log('0' + a + '/' + b + '/' + c)
} else if (
    parseInt(a) > 9 && parseInt(a) <= 31 && parseInt(b) > 0 && parseInt(b)
) {
    console.log(a + '/' + '0' + b + '/' + c)
} else {
